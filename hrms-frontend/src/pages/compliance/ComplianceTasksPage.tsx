...
interface Task extends Record<string, unknown> { id: string; title: string; category?: string; dueDate?: string; assignee?: string; status: string }
...
export function ComplianceTasksPage() {
  return (
    <ResourcePage<Task>
      ...
      fetcher={() => complianceTaskService.list() as Promise<unknown>}
